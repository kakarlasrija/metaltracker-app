    ...
    <>
      ...
      <div className="center">
        ...
        <div className="image">
          ...
          <h3>1 Gram = Rs {data.rates.PL} </h3>
          <h3>10 Gram = Rs {data.rates.PL * 10}</h3>
          <h3>1 Ounce = Rs {data.rates.PL * 28.35}</h3>
        </div>
      </div>
    </>
  );
